...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <form class="needs-validation" method="post" action=" {{url('/edit-quadro',$qd->id)}} " novalidate>
                {{ csrf_field() }}
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control form-control-sm" id="validationTooltip01" name="disciplina" required>
                          ...
                          {{-- @foreach($qd as $disciplina_active) --}}
                          <option value="{{$qd->disciplina}}">{{$qd->disciplina}}</option>
                          {{-- @endforeach --}}
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control form-control-sm" id="exampleFormControlSelect1" name="ciclo">
                      ...
                      {{-- @foreach($qd as $disciplina_active) --}}
                      <option value="{{$qd->ciclo}}">Ciclo {{$qd->ciclo}}</option>
                      {{-- @endforeach --}}
              ...
              <div class="col-md-3 mb-3">
                ...
                <select class="form-control form-control-sm" id="exampleFormControlSelect1" name="dia" required>
                  ...
                  <option value="{{$qd->dia}}">
                    ...
                    @elseif($qd->dia == 'terca')
                      Terça-Feira
                    @elseif($qd->dia == 'quarta')
                      Quarta-Feira
                    @elseif($qd->dia == 'quinta')
                      Quinta-Feira
                    @elseif($qd->dia == 'sexta')
                      Sexta-Feira
                    @elseif($qd->dia == 'sabado')
                      Sábado
                    @elseif($qd->dia == 'domingo')
                      Domingo
                    @endif</option>
          ...
          <div class="col-md-2 mb-3">
            ...
            <select class="form-control form-control-sm" id="exampleFormControlSelect1" name="tempo" required>
              {{-- <option>Tempo</option> --}}
              <option value=""></option>
